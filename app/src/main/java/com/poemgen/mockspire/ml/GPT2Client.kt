...
//            val totalString = prompt + completion
//            var outputString = ""
//
//            if (generationComplete) {
//                outputString = prompt + completion
//            } else {
//                outputString = totalString.substring(0, totalString.length - 5) + getRandomString(5)
//            }

            val str = SpannableStringBuilder(prompt + completion)
//            val str = SpannableStringBuilder(outputString)

//            val str = SpannableStringBuilder("bipple")
